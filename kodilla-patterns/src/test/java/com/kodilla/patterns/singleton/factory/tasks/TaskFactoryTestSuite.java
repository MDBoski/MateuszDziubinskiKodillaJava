...
public class TaskFactoryTestSuite {
    ...
    public void testMakeShoppingTask() {
        ...
        //When
        com.kodilla.patterns.factory.tasks.Task shopping = taskFactory.makeTask(TaskFactory.SHOPPING,
                "My shopping list",
                "potatoes",
                "2.5");
    ...
    public void testMakePaintingTask() {
        ...
        TaskFactory taskFactory = new TaskFactory();
        //When
        com.kodilla.patterns.factory.tasks.Task painting = taskFactory.makeTask(TaskFactory.PAINTING,
    ...
    public void testMakeDrivingTask() {
        ...
        TaskFactory taskFactory = new TaskFactory();
        //When
        com.kodilla.patterns.factory.tasks.Task driving = taskFactory.makeTask(TaskFactory.DRIVING,
